...
--the custid, orderid, and orderdate columns from the Sales.Orders 
--table. 
...
select top 20 custid, orderid, orderdate from sales.orders
...
--and modify the--
--- OFFSET-FETCH clause 
--to skip the first 20 rows and fetch the next 20 rows.
