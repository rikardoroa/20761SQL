...
-- the custid and contactname columns from
--- the Sales.Customers table and the 
--orderid and orderdate columns from the Sales.Orders table.
 
-- Filter the results to include only orders 
--placed on or after April, 1 2008 (filter the orderdate column). 
-- Then sort the result by orderdate in descendingorder 
--and custid in ascending order.
--
...
-- Task 2
-- 
-- Execute the query exactly as written inside a query 
--window and observe the result.
--
